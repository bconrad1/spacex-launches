...
const Payload = ({payloads}) => {
  return (
      <div className={'row-extra-payload-container'}>
        <div
            className={'row-extra-details-payload-header header'}>{'PAYLOAD INFORMATION'}</div>
          ...
          {_.map(payloads, (payload, index) => {
            return (
                ...
                <tr>
                  ...
                  <td>{`${payload.payload_mass_kg ||
                  'N/A'}/${payload.payload_mass_lbs || 'N/A'}`}</td>
                </tr>
                </tbody>
            );
          })
